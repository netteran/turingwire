  ...
  return (
    <>
      <p className="text-sm tw-muted mb-6 max-w-2xl">
        These replace the old <code className="font-mono text-xs">feeds/*.yml</code> files.
        Changes take effect on the next ingest run — no deploy needed. Deactivating a
        source leaves its articles in place.
      </p>
